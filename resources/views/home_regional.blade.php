...
@section('content')
                        ...
                        <div>                            
                            <div class="table-responsive">
                                <table class="table table-borderless">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>{{sizeof($localidades)}}</td>
                                            <td>{{$qtd_encarregados}}</td>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12 ">
                <div class="panel panel-default">
                    <div class="panel-heading"><b>Localidades</b></div>
                    <div class="table-responsive">
                        <div class="panel-body">
                            <table class="table table-borderless">
                                <thead>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12 ">
                <div class="panel panel-default">
                    <div class="panel-heading"><b>Enc. Locais</b></div>
                    <div class="table-responsive">
                        <div class="panel-body">
                            <table class="table table-borderless">
                                <thead>
                                    ...
                                    @foreach($musicos as $musico)
                                        @if($musico->status == 'enc_local')
                                            <tr>
                                                ...
                                                <td>
                                                    @foreach($localidades as $localidade)
                                                        @if($localidade->id == $musico->localidade_id)
                                                            {{$localidade->nome}}
                                                            @break
                                                        @endif
                                                    @endforeach
                        ...
                        <div class="panel-body">
                            <table class="table table-borderless">
                                ...
                                <tbody>
                                    @foreach($localidades as $localidade)
                                        @foreach($musicos as $musico)
                                            @if((($musico->status == 'oficial' || $musico->status == 'oficializado' || $musico->status == 'auxiliar' || $musico->status == 'instrutor' || $musico->status == 'enc_local' || $musico->status == 'enc_regional') && $musico->instrumento != 'Órgão') && $musico->localidade_id == $localidade->id)
                                                <tr>
                                                    <td>{{$musico->name}}</td>
                                                    <td>
                        ...
                        <div class="panel-body">
                            <table class="table table-borderless">
                                ...
                                <tbody>
                                    @foreach($localidades as $localidade)
                                        @foreach($musicos   as $musico)
                                            @if(($musico->status == 'rjm' && $musico->instrumento != 'Órgão') && $musico->localidade_id == $localidade->id)
                                                <tr>
                                                    <td>{{$musico->name}}</td>
                                                    <td>
                                                        @if($musico->status == 'iniciante')
                        ...
                        <div class="panel-body">
                            <table class="table table-borderless">
                                ...
                                <tbody>
                                    @foreach($localidades as $localidade)
                                        @foreach($musicos as $musico)
                                            @if(($musico->instrumento == 'Órgão' && ($musico->status == 'rjm' || $musico->status == 'oficial' || $musico->status == 'oficializado' || $musico->status == 'auxiliar' || $musico->status == 'instrutora' || $musico->status == 'examinadora')) && $musico->localidade_id == $localidade->id)
                                                <tr>
                                                    <td>{{$musico->name}}</td>
                                                    <td>
                                                        @if($musico->status == 'iniciante')
                        ...
                        <div class="panel-body">
                            <table class="table table-borderless">
                                ...
                                <tbody>
                                    @foreach($localidades as $localidade)
                                        @foreach($musicos as $musico)
                                            @if(($musico->instrumento != 'Órgão' && ($musico->status == 'iniciante' || $musico->status == 'ensaio' || $musico->status == 'rjm' || $musico->status == 'oficial')) && $musico->localidade_id == $localidade->id)
                                                <tr>
                                                    <td>{{$musico->name}}</td>
                                                    <td>
                                                        @if($musico->status == 'iniciante')
