...
<div class="row">
    <div class="col-md-8 col-md-offset-2">
        <div class="panel panel-default">
            <div class="panel-heading"><b>{!! $paise->nome !!}</b></div>
            <div class="panel-body">
                <div class="table-responsive">
                    <table class="table table-borderless">          
                        <tbody>
                            <tr>
                                <th class="col-md-2"> Nome </th><td class="col-md-10"> {!!$paise->nome!!} </td>
                            </tr>
                            <tr>
                                <th class="col-md-2"> Sigla </th><td class="col-md-10"> {!!$paise->sigla!!} </td>
                            </tr>
                        </tbody>
                    </table>
                </div>
                ...
                <div class="pull-right">
                    <a href="{{ url('/paise/') }}" class="btn btn-warning">
